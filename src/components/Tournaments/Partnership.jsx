...
function Partnership(){
    return (
        <main className="p-4 lg:py-16">
            ...
            <hr className="border-[1px] border-ash border-solid w-full"/>

            <section className="my-10 container mx-auto grid grid-cols-1 lg:gap-16 ">
                <div className="py-2">
                    <div className="relative w-full h-full">
                        <Image src={require("../../assets/images/air-peace.jpeg")} alt="aysc" objectFit={"cover"} />
                    </div>
                </div>
                ...
                <div className="py-2">
                    <div className="mb-8">
                        <h3 className="text-2xl lg:text-5xl text-deep font-extrabold">PANASA Partners Air Peace</h3>
                    </div>

                    <div className="my-4">
                        <p className="text-darkash text-sm">
                            Following the Partnership between the Pan African Scrabble Association (PANASA) and Air Peace Limited, the following routes will now attract a 20% discount on air ticket fares. These are:
                        </p>


                        <ul className="my-6 bg-ash p-6 rounded-lg border-2 border-sitepink grid grid-cols-1 lg:grid-cols-2 lg:gap-10 gap-y-8">
                            <div>
                            <li className="my-3 font-bold text-deep">The Routes:</li>
                            <li className="my-3">Monrovia (ROB) – Lagos (LOS) – Monrovia (ROB)</li>

                            <li className="my-3">Freetown (FNA) – Lagos (LOS) – Freetown (FNA)</li>

                            <li className="my-3">Accra (ACC) – Lagos (LOS) – Accra (ACC)</li>

                            <li className="my-3">Banjul (BJL) – Lagos (LOS) – Banjul (BJL)</li>

                            <li className="my-3">Douala (DLA) – Lagos (LOS) – Douala (DLA)</li>

                            <li className="my-3">Johannesburg (JNB) – Lagos (LOS) – Johannesburg (JNB)</li>
                            </div>

                            <div>
                                
                                <li className="my-3 font-bold text-deep">Booking Process:</li>

                                <li className="my-3">1. Interested players should send an email to: info@panafricanscrabble.com stating the ff; Gender, Title, First Name, Last Name, Nationality, Departing from, Departure Date, Return Date (for Round Trip), ID Card type, ID Card Number, Telephone Number (Including Country Code), Date of Birth (Adult is 12+) and Email address. 

                                <br/>Note: Given names must appear the same way they are on the player's passport.</li>

                                <li className="my-3">2. PANASA will forward details to Air Peace Limited.</li>

                                <li className="my-3">3. Air Peace Limited will make the reservation and share reservation details with PANASA and the player by email. This will include the ticket price, the payment options available and payment deadline.</li>

                                <li className="my-3">4. Player pays and shares confirmation back with PANASA and Air Peace Limited.</li>

                                <li className="my-3">5. Air Peace Limited confirm payment and issue ticket.</li>

                                <li className="my-3">6. PANASA to pick player up at the Airport on arrival in Lagos, Nigeria.</li>
                        ...
                        <div className="my-4">
                            <p>We enjoin all players attending the Africa Youth Scrabble Championship and the President’s Cup to take advantage of the reduced fares. This can be done by booking your tickets early to avail of low fares.

                            The partnership with Air Peace Limited will continue beyond the Championships in August 2023, covering all PANASA events in the future.</p>
